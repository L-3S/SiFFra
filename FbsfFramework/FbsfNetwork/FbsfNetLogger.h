#ifndef FbsfNetLogger_H
#define FbsfNetLogger_H
...
/***                                     GENERAL USAGE                                          ***/
/***                                                                                            ***/
/***  1. Create an instance: FbsfNetLoggerManager *manager = FbsfNetLoggerManager::getInstance();***/
...
namespace FbsfNetLogger
{
    ...
    /**
     * @brief The FbsfNetLoggerWriter class writes the message and manages the file where it is printed.
     */
    class FbsfNetLoggerWriter : public QObject
    {
        Q_OBJECT
        ...
        public:
             ...
             */
            explicit FbsfNetLoggerWriter(const QString &fileDestination, LogLevel level);
            /**
    ...
    /**
     * @brief The FbsfNetLoggerManager class manages the different destination files that we would like to have.
     */
    class FBSF_INTERFACE FbsfNetLoggerManager : public QThread
    {
        public:
            /**
             * @brief Gets an instance to the FbsfNetLoggerManager.
             * @return A pointer to the instance.
             */
            static FbsfNetLoggerManager * getInstance();
            /**
            ...
            /**
             * @brief Gets the FbsfNetLoggerWriter instance corresponding to the module <em>module</em>.
             * @param module The module we look for.
             * @return Retrns a pointer to the object.
             */
            FbsfNetLoggerWriter * getLogWriter(const QString &module) { return moduleDest.value(module); }
            /**
        ...
        private:
             ...
             */
            static FbsfNetLoggerManager *INSTANCE;
            /**
             * @brief Map that stores the module and the file it is assigned.
             */
            QMap<QString,FbsfNetLoggerWriter*> moduleDest;
            /**
