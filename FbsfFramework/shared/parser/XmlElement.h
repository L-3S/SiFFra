...
class Element {
 ...
 public:
    virtual ~Element();
    virtual void handleElement(XmlParser *parser, const char *childName, int isEmptyElement,const QDomElement& xmlElem);
...
class ListElement : public Element {
 ...
 public:
    ~ListElement();
    void handleElement(XmlParser *parser, const char *childName, int isEmptyElement,const QDomElement& xmlElem);
